...
function houseimgerror(obj,num3d) {//二手房、租房列表页404图片
    obj.onerror = "";
    if(num3d == 1){
...
function houseDetailimgerror(obj,num3d) {//二手房、租房404图片
    obj.onerror = "";
    if(num3d == 1){
    	obj.src = baseUrl+"/pc/common/images/detail404_3d.jpg";
    }else{
    	obj.src = baseUrl+"/pc/common/images/houseDetail404.jpg";
    }
    obj.onerror=null;
    obj.jqimg = '';
}
...
function wechatspError(obj) {//微信小程序码404图片
    obj.onerror = "";
    obj.src = baseUrl+"/pc/sale/images/wechat-code.png";
    obj.onerror=null;
}
...
function foucusqrcodeerror(obj) {//关注的经纪人微信无二维码
	obj.parentNode.parentNode.className = "agent-wx weixin-no";
	obj.parentNode.parentNode.removeChild(obj.parentNode);	
}
...
function brokerwxerror2(obj) {//经纪人详情页微信无二维码
    obj.parentNode.parentNode.className = "wxBox huis";
    obj.parentNode.parentNode.removeChild(obj.parentNode);
}
function housedetailerror(obj,num3d) {//房源，小区详情页404图片
    obj.onerror = "";
    if(num3d == 1){
    	obj.src = baseUrl+"/pc/common/images/detail404_3d.jpg";
    }else{

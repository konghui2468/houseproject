...
function customPrice() {
    ...
    if (priceLow < 0 || priceLow >= priceTop) {
        openPop('请输入正确的范围', '', '1');
        return false;
    }
 ...
 * 清空条件跳转
 */
function cleanSelectXiaoqu (xiaoquurl) {
    window.location.href = '/xq-ershoufang/'+xiaoquurl;
}
